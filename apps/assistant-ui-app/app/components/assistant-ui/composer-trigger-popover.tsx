        ...
        {categories.map((cat) => {
          ...
          return (
            <ComposerPrimitive.Unstable_TriggerPopoverCategoryItem
              key={cat.id}
              categoryId={cat.id}
              className="hover:bg-muted/60 focus:bg-muted/60 data-[highlighted]:bg-muted data-[highlighted]:font-medium flex cursor-pointer items-center justify-between gap-2 px-3 py-2 text-sm rounded-md mx-1 transition-colors outline-none"
            >
            ...
            {items.map((item, index) => {
              ...
              return (
                <ComposerPrimitive.Unstable_TriggerPopoverItem
                  ...
                  item={item}
                  index={index}
                  className="hover:bg-muted/60 focus:bg-muted/60 data-[highlighted]:bg-muted flex w-full cursor-pointer flex-col items-start gap-0.5 px-3 py-2 text-start rounded-md mx-1 transition-colors outline-none"
                >
